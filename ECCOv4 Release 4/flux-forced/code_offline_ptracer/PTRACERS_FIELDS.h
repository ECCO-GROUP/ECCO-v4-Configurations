...
C     surfaceForcingPTr :: passive tracer surface forcing
     ...
     &              PTRACERS_num)
      _RL  surfaceForcingPTr0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy,
     &              PTRACERS_num)
      _RL  surfaceForcingPTr1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy,
     &              PTRACERS_num)
      COMMON /PTRACERS_FIELDS/
     &              pTracer, gpTrNm1, surfaceForcingPTr,
     &              surfaceForcingPTr0, surfaceForcingPTr1
