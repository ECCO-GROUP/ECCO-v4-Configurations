...
C     {fld}const      :: uniform default field value
      ...
      INTEGER spflxstartdate1
      INTEGER spflxstartdate2
      _RL     spflxStartTime
      _RL     spflxperiod
      _RL     spflxRepCycle
      _RL     spflxconst
      _RL     spflx_exfremo_intercept
      _RL     spflx_exfremo_slope
      character*1 spflxmask
...
C-    File names.
     ...
     &       spflxstartdate1, spflxstartdate2,
     ...
     &       spflxconst,      spflxRepCycle,
     &       spflxperiod,     spflxStartTime,
...
C    uvInterp_climstr    :: interpolate clim stress u & v components together
      ...
      _RL spflx_lon0, spflx_lon_inc
      _RL spflx_lat0, spflx_lat_inc(MAX_LAT_INC)
      INTEGER spflx_nlon, spflx_nlat, spflx_interpMethod
     ...
     & spflx_lon0, spflx_lon_inc,
     & spflx_lat0, spflx_lat_inc,
     ...
     & spflx_nlon, spflx_nlat, spflx_interpMethod,
