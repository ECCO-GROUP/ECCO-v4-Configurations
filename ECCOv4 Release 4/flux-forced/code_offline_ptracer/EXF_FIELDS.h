...
C     zen_fsol_daily     :: incoming solar radiation (daily mean)
     ...
     &     zen_albedo, zen_fsol_diurnal, zen_fsol_daily
      ...
      COMMON /exfl_spflx/ spflx, spflx0, spflx1
      _RL spflx (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL spflx0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL spflx1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
#endif
